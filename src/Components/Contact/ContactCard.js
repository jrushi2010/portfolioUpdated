    ...
    return (
        <div className='z-50 grid grid-cols-12 px-4 py-4 lg:px-20 lg:py-14 bg-indigo-900 bg-opacity-60 rounded-3xl backdrop-blur-lg justify-center'>
            <div className='col-span-12 lg:col-span-6'>
                <p className='font-bold text-lg px-2 py-2'>Get in touch</p>

                <p className='pl-2 lg:pr-40 py-6'>I’m very approachable and would love to speak to you. Feel free to call, send me an email . Follow me in social media or simply complete the enquiry form.</p>
            ...
            <div className='col-span-12 lg:col-span-6'>
                <p className='font-bold text-lg px-2 py-2'>Send me message</p>
